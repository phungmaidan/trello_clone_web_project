  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        /*
          * Phía Front-end sẽ tự tạo một card đặc biệt: Placeholder Card, không liên quan tới Back-end.
          * Card đặc biệt này sẽ được ẩn ở giao diện UI người dùng.
          * Cấu trúc Id của card này để Unique rất đơn giản, không cần phải random phức tạp.
